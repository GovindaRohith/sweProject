...
const [id_forgot, setId_forgot] = useState(
  ...
  const handleSubmit1 = (e) => {
    ...
    axios.post('/forgot_password', id_forgot)
        .then((res) => {
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <label for="forgot_id" style={{fontSize: '18px'}}>Enter your ID:</label>

                            <input type="text" class="form-control" id="forgot_id" name="forgot_id" value={id_forgot.forgot_id} placeholder="Enter your ID" onChange={handleChange1} />
                        </div>
                        <br/>
